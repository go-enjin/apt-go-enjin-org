module github.com/go-enjin/apt-go-enjin-org
...
require (
	...
	github.com/go-enjin/semantic-enjin-theme v0.4.0
	github.com/go-enjin/starter-apt-enjin v0.0.0-20230828203110-9e5d153bc4a6
)
